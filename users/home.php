...
$newsletterQuery = "SELECT * FROM newsletters";
$newsletterResult = mysqli_query($conn, $newsletterQuery);

if (!$newsletterResult) {
    die("Newsletter query failed: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="services" id="services">
        <h1>Services</h1>
        <!-- <?php echo $_SESSION['user_data']['subscription'] ?> -->
        <div class="service-grid">
            ...
            <div class="service-box">
                <img src="../uploads/WhatsApp+Image+2023-05-02+at+1.07.56+PM.jpeg"
                    alt="Placeholder image representing the service provided">
            ...
            <div class="service-box">
                <img src="../uploads/64d1b1cb181c1b149ad39fab_get-course-blog-main-image-4.webp"
                    alt="Placeholder image representing the service provided">
            ...
            <div class="service-box">
                <img src="../uploads/istockphoto-1131233305-612x612.jpg"
                    alt="Placeholder image representing the service provided">
    ...
    <section class="howParentsSections" id="howParentsSections">
    ...
    <section id="newsletters">
        <h2>Newsletters</h2>
        <?php
        // Loop through each newsletter fetched from the database
        while ($newsletter = mysqli_fetch_assoc($newsletterResult)) {
            echo "
            <div class='newsletter-item'>
                <h3>" . htmlspecialchars($newsletter['title']) . "</h3>
                <img src='" . htmlspecialchars($newsletter['image1']) . "' alt='Newsletter Image'>
                <p>" . nl2br(htmlspecialchars($newsletter['content'])) . "</p>
                <label><strong class='p_date'>Published Date:</strong> " . htmlspecialchars($newsletter['publisheddate']) . "</label>
            </div>";
        }
        ?>
    </section>
